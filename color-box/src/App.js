    ...
    return (
      <div className="App">
        {this.state.boxColors.map((color, index) => {
            return <Boxes key={index} color={this.props.allColors[color]}/>;
        })}
